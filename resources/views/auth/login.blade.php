@extends('layouts.applogin', [
  ...
  'activePage' => 'login',
  'title' => __('Ciclica'),
  'pageBackground' => asset("material").'/img/fon.jpg'
])

@section('content')
<div class="container">
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto " align="center">
                      <img src="{{ asset('material') }}/img/logociclica.png" style="padding: 30px; width: 200px; height: 200px;" /> 
        </br>
        </br>
        ...
        <form class="form" method="POST" action="{{ route('login') }}">
          ...
          <div class="card card-login card-hidden">        
            ...
            <div class="card-footer justify-content-center">
              <button type="submit" class="btn btn-rose btn-link color-text-1">{{ __('Aceptar') }}</button>
            </div>
          </div>
        </form>
      </div>
