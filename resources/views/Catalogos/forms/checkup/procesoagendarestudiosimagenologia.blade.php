@extends('layouts.appagendarestudios', ['activePage' => 'form_wizard', 'menuParent' => 'forms', 'titlePage' => __('Consulta')])
            ...
            <div class="card-body">
                  <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12 mt-3">
                      <div class="input-group form-control-lg">
                        <label class="col-sm-12 col-form-label text-center">{{ $descripcion }}</label>   
                      </div>
                    </div>
                  </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLongTitle">Agendar Citas de Imagenologia</h3>
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="form-group bmd-form-group is-filled">
                    ...
                    <input name="numpac" id="numpac" type="hidden" value="nueva cita">
...
<script src="{{ asset('js') }}/citasimagenologia.js"></script>
 ...
 function citas(){
   ...
   var anotaciones =  $("#id_anotaciones").val();
      ...
      $.ajax({
        type: "POST",
        dataType: "json",
        url: "https://ciclica.lealtaddigitalsoft.mx/public/citasimagenologia/add",
        data: {_token: "{{ csrf_token() }}", start: varistart, end: variend, pac: paciente, nota: notas, anotaciones: anotaciones},
