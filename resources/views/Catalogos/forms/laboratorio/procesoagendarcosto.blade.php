        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">Agregar costos</h4>
              </div>
              <div class="card-body">
                 <div class="row">
...
@endsection
 ...
 @include("Catalogos.forms.caja.caja_citas_laboratorio")
    ...
    $.each(fields,function(index,value){columns.push({'data':value});});
      ...
      $('#datatables').fadeIn(1100);
        $('#datatables').DataTable( {
            "processing": true,
            "ajax": {
               "url": 'https://ciclica.lealtaddigitalsoft.mx/public/agendarcajalabojlistt',
               "type": 'POST',
               "data": parametros,
             },
