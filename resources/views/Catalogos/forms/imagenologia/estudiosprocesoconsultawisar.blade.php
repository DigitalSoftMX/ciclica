@extends('layouts.appimagenologia', ['activePage' => 'form_wizard', 'menuParent' => 'forms', 'titlePage' => __('Consulta')])
                    ...
                    <tbody>
                      @foreach($resultadosmedicos as $item)
                        ...
                        <td>
                          ...
                          <th>
                            <a href="#" class="btn btn-sm btn-rose" data-toggle="modal" data-target=".docs-exampleedit-modal-lg">{{ __('Editar') }} </a>
                            <a href="{{route('addimagenologiadelete',$item->id)}}" class="btn btn-sm btn-rose">{{ __('Eliminar') }} </a>
                      </th>
                      @endforeach
                    </tbody>
                  </table>
