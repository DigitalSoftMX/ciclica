                  ...
                  <div class="row ">
                    <div class="col-sm-12">
                      <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                        <textarea  rows="4" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="indica" id="input-description" type="text" placeholder=""  aria-required="true">{{ $agenest }}</textarea>
...
<div class="modal fade docs-modalreceta-modal-lg" id="modalreceta" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
              ...
              <div class="tab-pane active">
                <div class="card-body ">
                  ...
                  <div class="row ">
                    <div class="col-sm-12">
                      <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                        <textarea  rows="8" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="receta" id="input-description" type="text" placeholder=""  aria-required="true">{{ $recet->receta }}</textarea>
                        @include('alerts.feedback', ['field' => 'description'])
                      </div>
                    </div>
                  </div>
              ...
              <div class="tab-pane active">
                <div class="card-body ">
                  ...
                  <div class="row ">
                    <div class="col-sm-12">
                      <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                        <textarea  rows="8" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="receta" id="input-description" type="text" placeholder=""  aria-required="true"></textarea>
                        @include('alerts.feedback', ['field' => 'description'])
                      </div>
                    </div>
                  </div>
...
<!-- Modal -->
<div class="modal fade docs-modalanexo1-modal-lg" id="modalanexo1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
