@extends('layouts.appusuarios', ['activePage' => 'form_regular', 'menuParent' => 'forms', 'titlePage' => __('Regular Forms')])
            ...
            <div class="card-body ">
              ...
              <div class="tab-content tab-space">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="username" id="username" type="text" placeholder="No. del Paciente" value="{{ $fo->username }}" number="true">
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group is-filled">
                      <input class="form-control datepicker" name="fecha_nacimiento" id="fecha_nacimiento" type="text" placeholder="Fecha de nacimiento" value="{{ $fo->fecha_nacimiento }}">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group">
                      <div class="dropdown bootstrap-select col-sm-12 pl-0 pr-0"><select class="selectpicker col-sm-12 pl-0 pr-0" name="id_edo_civil" id="id_edo_civil" data-style="select-with-transition" title="" data-size="100" tabindex="-98">
                        <option value="{{ $fo->idedocivil }}">{{ $fo->edovicilname }}</option>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="telefono" id="telefono" type="text" placeholder="Telefono de casa" value="{{ $fo->telefono }}">
                    </div>
                  </div>
                ...
                <div class="tab-pane" id="link2">
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="ciudad" id="ciudad" type="text" placeholder="Ciudad" value="{{ $fo->ciudad }}" >
                    </div>
                  </div>
                  <label class="col-sm-2 col-form-label">Estado</label>
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="id_estado_domicilio" id="id_estado_domicilio" type="text" placeholder="Estado" value="{{ $fo->id_estado_domicilio }}">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="colonia" id="colonia" type="text" placeholder="Colonia" value="{{ $fo->colonia }}" >
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="calle" id="calle" type="text" placeholder="Calle" value="{{ $fo->calle }}">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="cp" id="cp" type="text" placeholder="Codigo Postal" value="{{ $fo->cp }}">
                    </div>
                  </div>
                  <label class="col-sm-2 col-form-label">No. de exterior</label>
                  <div class="col-sm-2">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="num_ext" id="num_ext" type="text" placeholder="No. de exterior" value="{{ $fo->num_ext }}" >
                    </div>
                  </div>
                  <label class="col-sm-2 col-form-label">No. de interior</label>
                  <div class="col-sm-2">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="num_int" id="num_int" type="text" placeholder="No. de interior" value="{{ $fo->num_int }}">
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane" id="link3">
                  ...
                  <div class="col-sm-10">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="tipo_sangre" id="tipo_sangre" type="text" placeholder="Tipo de sangre" value="{{ $fo->tipo_sangre }}" >
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="alergias" id="alergias" type="text" placeholder="Alergias" value="{{ $fo->alergias }}">
                    </div>
                  </div>
                </div>

                <div class="row">
                  <label class="col-sm-2 col-form-label">Ocupaci贸n</label>
                  <div class="col-sm-10">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="ocupacion" id="ocupacion" type="text" placeholder="Ocupacion" value="{{ $fo->ocupacion }}" >
                    </div>
                  </div>
                </div>
               ...
               <!-- cuarto metodo del panel-->
                ...
                <div class="row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="nombre_pareja" id="nombre_pareja" type="text" placeholder="Nombre de la pareja" value="{{ $fo->nombre_pareja }}" >
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group">
                      <input class="form-control datepicker" name="fch_nacimiento_pareja" id="fch_nacimiento_pareja" type="text" placeholder="Fecha de nacimiento" value="{{ $fo->fch_nacimiento_pareja }}">
                      </div>
                  </div>
                  <label class="col-sm-2 col-form-label">Ocupacion de la Pareja</label>
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="ocupacion_pareja" id="ocupacion_pareja" type="text" placeholder="Ocupacion de la Pareja" value="{{ $fo->ocupacion_pareja }}" >
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="celular_pareja" id="celular_pareja" type="text" placeholder="Celular de la pareja" value="{{ $fo->celular_pareja }}">
                    </div>
                  </div>
                  <label class="col-sm-2 col-form-label">Correo electronico de la pareja</label>
                  <div class="col-sm-4">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="email_pareja" id="email_pareja" type="text" placeholder="Correo electronico de la pareja" value="{{ $fo->email_pareja }}">
                    </div>
                  </div>
                </div>
