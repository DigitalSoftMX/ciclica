      ...
      <!-- AGENDAR -->
                   ...
                   <div class="col-md-12 ml-auto mr-auto">
                      <div class="card card-calendar">
                        <div class="card-body ">
                          @csrf
                            <div class="form-row py-3 px-4 d-flex align-items-center color-back-1">
                                <label class="col-auto col-form-label p-0 mr-2">Especialidad</label>
                                <input class="col-auto  p-0 mr-5" name="id_especialidad" id="id_especialidad" type="text" placeholder="Especialidad" required="true" aria-required="true">
                                <div class="col-auto ml-3">
                                    <label class="col-auto col-form-label p-0 mr-2">Medico</label>
                                <input class="col-auto  p-0 mr-2" name="id_usuario" id="id_usuario" type="text" placeholder="Medico" required="true" aria-required="true">
                                    
                                </div>
                            </div> 
                          <div class="p-0" id="fullCalendar"></div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="form-group bmd-form-group is-filled">
                    ...
                    <input name="title" id="title" value="{{ $almacen }}" type="hidden">  
