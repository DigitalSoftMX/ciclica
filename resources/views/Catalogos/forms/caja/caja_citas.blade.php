  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLongTitle">Agregar costo a la cita</h3>
                            ...
                            <div class="modal-body">
                                <div class="input-group form-control-lg">
                                    <div class="form-group col-sm-12">
                                      <input type="text" class="form-control col-sm-12" id="id_precio" name="id_precio" style="width:100%" required>
                                    </div>
                                </div>
                            </div>
