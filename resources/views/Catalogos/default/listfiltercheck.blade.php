@extends('layouts.appdoctorescheckup', ['activePage' => 'category-management', 'menuParent' => 'laravel', 'titlePage' => ' '])
        ...
        $('#datatables').DataTable( {
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row){ 
                    return '<a rel="tooltip" href="#" class="btn btn-success btn-link" data-toggle="modal" data-target=".docs-example-modal-lg" onclick="tipo('+data+')"><i class="material-icons">edit</i></a>' 
                      + '<a rel="tooltip" href="'+url_delete+data+'" class="btn btn-danger btn-link" data-original-title="" title="" ><i class="material-icons">close</i></a>' 
      ...
      $('#datatables').fadeIn(1100);
        $('#datatables').DataTable( {
            ...
            "columnDefs": [{
                "targets": -1,
                "render": function(data, type, row){ 
                     return '<a href="#" data-toggle="modal" data-target=".docs-exampleedit-modal-lg"><span class="material-icons">edit</span></a>'       
        ...
        { 
            if('{{$catalog->getUrlPrefix()}}' == "citascheckup" || '{{$catalog->getUrlPrefix()}}' == "citascheckupfinalizado"){  
                if(aData['archivo'] == null){
                    ...
                    $('td:eq(3)', nRow).html( '<a href="download/+aData+"><span class="label label-primary">Descargar</span></a>' );
                }
                return nRow;
            }
        }
