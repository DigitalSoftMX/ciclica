@extends('layouts.appusuarios', ['activePage' => 'category-management', 'menuParent' => 'laravel', 'titlePage' => __('Category Management')])
    ...
    $.each(fields,function(index,value){columns.push({'data':value});});
      ...
      $('#datatables').fadeIn(1100);
        $('#datatables').DataTable( {
            "processing": true,
            "ajax": "https://ciclica.lealtaddigitalsoft.mx/public/recetasjlistl/{{$id}}",
