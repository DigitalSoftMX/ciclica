...
<div class="content">
  <div class="container-fluid">
    <div class="header text-center">
      <h3 class="title">Citas Estudios</h3>
    </div>
    <div class="row">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLongTitle">Agendar Estudio</h3>
            ...
            <div class="tab-content">
                  ...
                  <div class="col-md-5 mr-auto ml-auto">
                    <div class="card ">
                      <div class="card-header card-header-rose card-header-text">
                        ...
                        <h4 class="card-title">Tiempo de cita</h4>
                      </div>
                      <div class="card-body ">
                        <div class="form-group">
                          <input type="text" class="form-control timepicker" name="fechaend">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
               ...
               <!-- <label class="col-sm-2 col-form-label">Especialidad</label>
                <div class="col-sm-10">
                  <div class="form-group bmd-form-group is-filled">
                    <input class="form-control" name="id_especialidads" id="id_especialidads" type="text" placeholder="Especialidad" required="true" aria-required="true">
                  </div>
                </div>-->
...
<script src="{{ asset('js') }}/citasestudios.js"></script>
<script>
 function citas(){
