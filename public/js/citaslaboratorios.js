...
// $('.modalactualizar').modal();
    ...
    if(event.img === undefined){
        ...
        var result = $.ajax({
               type: "GET",
               dataType: "json",
               url: "https://ciclica.lealtaddigitalsoft.mx/public/selectcitadeletelabo/"+""+formDateSF+"",               
...
events: function(start, end, timezone, callback) {
        $.ajax({
               type: "GET",
               dataType: "json",
               url: "https://ciclica.lealtaddigitalsoft.mx/public/selectcitaslaboratorios",               
...
function deletecitas(ids){
    // alert(ids);
      $.ajax({
        type: "GET",
        dataType: "json",
        url: 'https://ciclica.lealtaddigitalsoft.mx/public/citaslaboratorio/destroy/' + ids,          
        success: function (data) {
                    var item = [];
