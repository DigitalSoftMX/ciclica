 ...
 ***************************************************************************/
	...
	0 => array ('UN ','DOS ','TRES ','CUATRO ','CINCO ','SEIS ','SIETE ','OCHO ','NUEVE ','UN '),
 ...
 *	setGenero:	Asigan genero setMayusculas:	Asigna uso de mayusculas o minusculas
 ...
 ***************************************************************************/	
	...
	function letra(){
		...
		if(($this->numero>=1000) && ($this->numero<2000)){
			$auxiliar = explode("(***", $texto);
			$texto = "(*** UN".$auxiliar[1];
		}
		
		if(($this->numero>=1000000) && ($this->numero<2000000)){
			$auxiliar = explode("(***UN MILLONES", $texto);
			$texto = "(***UN MILLON".$auxiliar[1];
		}
